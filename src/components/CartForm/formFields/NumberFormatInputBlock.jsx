...
import NumberFormat from "react-number-format"; // Імпортуємо компонент NumberFormat для форматування введеного номера телефону
...
export const NumberFormatInputBlock = ({ name, label, id, placeholder, type }) => {
    ...
    return <div key={id} className={styles.fieldContainer}>
        ...
        <NumberFormat
            ...
            format="+38 (###) ###-##-##" // Формат номера телефону
            allowEmptyFormatting mask="_" // Дозволяємо пусте форматування та встановлюємо маску "_"
            name={name}
