...
import { useDispatch, useSelector } from 'react-redux' // Імпортуємо функції для взаємодії зі стором Redux.
...
const Cart = () => {
  ...
  const deleteFromCartHandler = (articul) => {
    dispatch(removeFromCart(articul)) // Функція для видалення товару з кошика із використанням Redux.
  }
